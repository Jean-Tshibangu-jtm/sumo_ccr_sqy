...
def modify_flow_periods(file_path, prefix, suffix, new_value, new_color):
    ...
    for flow_elem in root.iter('flow'):
        ...
        if flow_id.startswith(prefix) and flow_id.endswith(suffix):
...
if __name__ == '__main__':
    ...
    parser.add_argument('prefix', type=str, help='Starting pattern for flow IDs')
    ...
    modify_flow_periods(args.file_path, args.prefix, args.suffix, args.new_value, args.new_color)
